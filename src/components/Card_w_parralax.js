...
const Card_w_parralax = () => {
    ...
    <div >
        ...
        <Row gutter={[16,16]} justify='center' wrap="false" style={{marginTop:"5%",marginBottom:"5%", backgroundImage: "url(https://source.unsplash.com/random)",
        ...
        items.map((data) => {
            return(
                <Card hoverable= {false} bordered={"false"} bodyStyle={{padding:3}} style={{background: "rgba(255, 255, 255, 2)",margin:"5% 3%",maxWidth:300,border:"0",borderRadius:"10%"}} cover={
                    <img style={{maxHeight:"",borderRadius:"10%"}} src='./sample2.jpg' alt="Services_list"></img>
                  }>
